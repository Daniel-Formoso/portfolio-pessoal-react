    ...
    <section id="sobre-mim">
      ...
      >
        ...
        <div className={styles.textoSobreMim}>
          <p>
          Sou estudante do 7º período de Sistemas de Informação, focado em desenvolvimento front-end. Tenho experiência em HTML, CSS e JavaScript, criando interfaces responsivas e otimizadas. Recentemente, conclui cursos com certificados em HTML, CSS, JavaScript e React pela Alura, e estou aprofundando meus conhecimentos em React para entregar soluções modernas. Minha experiência na TV Globo como Jovem Aprendiz me ajudou a desenvolver habilidades em trabalho em equipe, comunicação eficaz e resolução de problemas. Estou sempre em busca de novos desafios e oportunidades para criar interfaces intuitivas e eficientes.
          </p>
        </div>
